        ...
        {!verified ? (
          <>
            ...
            <button 
              ...
              disabled={loading}
              className="w-full bg-gradient-to-r from-green-600 to-green-700 text-white font-extrabold py-4 rounded-xl shadow-lg hover:from-green-700 hover:to-green-800 transition transform active:scale-95 disabled:bg-gray-400 flex items-center justify-center gap-2 cursor-pointer text-base"
            >
              {loading ? (
          ...
          <div className="flex flex-col items-center py-8">
            <div className="w-24 h-24 bg-orange-100 rounded-full flex items-center justify-center animate-[bounce_1s_ease-in-out] shadow-inner">
              <svg className="w-12 h-12 text-orange-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="3" d="M5 13l4 4L19 7"></path>
              </svg>
            </div>
            <h3 className="text-2xl font-black text-orange-500 mt-5">{t('login_success')}</h3>
