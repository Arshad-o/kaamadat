...
export default function WorkerRegister() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        localStorage.setItem('kaammadat_pt_worker_photo', profilePhoto);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-orange-50 to-orange-100 flex flex-col items-center justify-center p-4 font-[family-name:var(--font-geist-sans)]">
      ...
      <div className="w-full max-w-md bg-white rounded-2xl shadow-2xl overflow-hidden border border-orange-100 transition hover:shadow-orange-100 relative z-10 lg:ml-72">
        <div className="bg-gradient-to-r from-orange-500 to-orange-600 p-6 text-center text-white">
          <h2 className="text-3xl font-extrabold tracking-tight">Part-Time Worker</h2>
        ...
        <form onSubmit={handleSubmit} className="p-8 flex flex-col gap-4">
          ...
          <div>
            ...
            <p className="text-xs text-orange-600 font-semibold mb-2">Note: This photo will appear on your dashboard card exactly as uploaded.</p>
            <div className="flex items-center gap-4">
              {profilePhoto && (
                <div className="w-16 h-16 rounded-full overflow-hidden border-2 border-orange-300 shrink-0">
              ...
              <input 
                ...
                className="w-full px-4 py-3 rounded-lg border border-gray-300 bg-white focus:ring-2 focus:ring-orange-500 outline-none transition text-sm cursor-pointer file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-orange-50 file:text-orange-700 hover:file:bg-orange-100" 
                required
              />
            </div>
          </div>
                ...
                <div className="bg-orange-50 border border-orange-200 p-4 rounded-xl mt-2 animate-[fade-in_0.3s_ease-out]">
                  ...
                  <div className="flex gap-2">
                    <input 
                      ...
                      className="flex-1 px-3 py-2 rounded-lg border border-orange-300 text-gray-900 bg-white focus:ring-2 focus:ring-orange-500 outline-none text-sm"
