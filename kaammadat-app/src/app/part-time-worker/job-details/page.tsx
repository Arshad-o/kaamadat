  ...
  return (
    <div className="min-h-screen bg-transparent font-[family-name:var(--font-geist-sans)] pb-20 relative z-0">
      ...
      <div className="relative h-56 w-full animate-[fade-in_0.4s_ease-in-out]">
         ...
         <Link href="/part-time-worker/search" className="absolute top-4 left-4 w-10 h-10 bg-white/30 backdrop-blur rounded-full flex items-center justify-center text-white font-extrabold hover:bg-white/50 transition">
           ←
         </Link>
