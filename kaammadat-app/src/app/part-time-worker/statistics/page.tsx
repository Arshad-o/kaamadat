  ...
  return (
    <div className="min-h-screen bg-gray-50 font-[family-name:var(--font-geist-sans)] pb-10">
      ...
      <header className="bg-blue-600 text-white p-5 shadow-md flex items-center gap-3 sticky top-0 z-10">
        <Link href="/part-time-worker/dashboard" className="w-9 h-9 rounded-full bg-white/20 hover:bg-white/30 flex items-center justify-center font-bold text-lg transition cursor-pointer">
          ←
        </Link>
