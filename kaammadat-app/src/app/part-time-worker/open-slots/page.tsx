  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-yellow-50 to-orange-50 font-[family-name:var(--font-geist-sans)] pb-24">
      <header className="bg-yellow-500 text-white p-4 shadow-md flex items-center gap-4 sticky top-0 z-10">
        <Link href="/part-time-worker/dashboard" className="text-white font-black text-xl hover:opacity-80">←</Link>
        <div>
      ...
      <main className="p-4 max-w-lg mx-auto mt-2">
        ...
        {loading ? (
          ...
          <div className="text-center mt-16">
            ...
            <Link href="/part-time-worker/search" className="inline-block mt-6 bg-orange-500 text-white font-bold px-8 py-3 rounded-xl shadow-md hover:bg-orange-600 transition">Browse All Jobs</Link>
          </div>
        ) : (
