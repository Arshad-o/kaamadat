            ...
            <div className="flex justify-center gap-2 mb-8">
              {otp.map((digit, i) => (
                <input 
                  ...
                  onPaste={handlePaste}
                  className="w-10 h-12 sm:w-12 sm:h-14 text-center text-2xl sm:text-3xl font-extrabold rounded-xl border-2 border-gray-300 text-gray-900 bg-white focus:ring-2 focus:ring-orange-500 focus:border-orange-500 outline-none transition" 
                />
              ))}
            </div>
